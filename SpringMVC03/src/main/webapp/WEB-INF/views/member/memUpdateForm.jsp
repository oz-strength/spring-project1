...
<head>
  ...
  $(document).ready(function(){
  	...
  	function goUpdate(){
  		...
  		if(memAge==null || memAge=="" || memAge.length<6){
  			alert("나이를 입력하세요");
  			return false;
  		}
...
<jsp:include page="../common/header.jsp"/>
  ...
  <div class="panel panel-default">
    ...
    <div class="panel-body">
    	...
    	<form name="frm" action="${contextPath}/memUpdate.do" method="post">
    		...
    		<tr>
    			...
    			<td colspan="2"><input id="memAge" name="memAge" class="form-control" type="number" maxlength="6" placeholder="ex)931017" value="${mvo.memAge}" /></td>
    		</tr>
    		<tr>
    ...
    <div class="panel-footer">oz-strength</div>
  </div>
</div>
